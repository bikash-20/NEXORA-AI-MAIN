...
function checkBikashKB(msg) {
  ...
  if (/who (made|built|created|coded|designed) (you|nexora)|nexora.*creator|your (developer|creator|maker)/.test(q)) return "I was built by <strong>Bikash Talukder</strong> — 2nd-year CSE student, from a reputated University, Sylhet. Vanilla JS, zero frameworks, 100% handcrafted. 💙";
